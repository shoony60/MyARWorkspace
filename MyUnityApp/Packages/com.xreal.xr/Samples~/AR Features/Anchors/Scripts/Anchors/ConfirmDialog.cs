...
namespace Unity.XR.XREAL.Samples
{
    public class ConfirmDialog : MonoBehaviour
    {
        ...
        public static readonly string ANCHORS_SAVE_FAIL_GUIDE = "Save failed. Please observer the anchor from multiple angles until most of the quality bar turns green.";
